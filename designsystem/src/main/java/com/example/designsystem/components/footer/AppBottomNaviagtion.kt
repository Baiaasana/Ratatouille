    ...
    AnimatedVisibility(
        ...
        content = {
            val bottomScreens = remember {
                listOf(
                    BottomScreens.Home,
                    BottomScreens.LiveAuction,
                    BottomScreens.BidHistory,
                        ...
                        NavigationBarItem(
                            ...
                            onClick = {
                                when (screen) {
                                    ...
                                    BottomScreens.LiveAuction ->  onEvent.invoke(NavigationEvent.Auctions)
                                    BottomScreens.BidHistory -> onEvent.invoke(NavigationEvent.Bids)
                                    BottomScreens.Profile -> onEvent.invoke(NavigationEvent.Profile)
                                }
                            },
                            icon = {
                                Icon(
