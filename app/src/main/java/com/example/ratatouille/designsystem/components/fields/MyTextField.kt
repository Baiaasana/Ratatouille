...
import com.example.ratatouille.data.Constants.EMAIL_REGEX
...
//                Patterns.EMAIL_ADDRESS.matcher(textFieldValue).matches()
        ...
        fieldType == FieldType.Phone && !android.util.Patterns.EMAIL_ADDRESS.matcher(textFieldValue)
            .matches() -> stringResource(id = R.string.invalid_format)

        else -> stringResource(id = R.string.invalid_format)
    }
